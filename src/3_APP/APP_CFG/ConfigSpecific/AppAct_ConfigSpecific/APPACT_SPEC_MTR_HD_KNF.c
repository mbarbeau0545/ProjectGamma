...
#include "./APPACT_SPEC_MTR_HD_KNF.h"
...
// *                      Defines
// ********************************************************************
///@brief Enable motor HD Knife Dead Time
#define APPACT_SPEC_MOTOR_HD_KNF_ENABLE_DEADTIME TRUE

#define APPACT_SPEC_MOTOR_HD_KNF_DIR_POS ((t_sint32)1)
...
/******************************************
* APPACT_SPEC_MTR_HD_KNF_SetCfg
******************************************/
t_eReturnCode APPACT_SPEC_MTR_HD_KNF_SetCfg(t_uint8 f_actDvcOpt_u8, t_eAPPACT_ActDriverList *f_drvUsed_pe)
{
    t_eReturnCode Ret_e;
    ...
    else
    {
        ...
        {
            case APPSYS_OPT_ACT_MTR_HD_KNF_UNUSED:
                Ret_e = RC_WARNING_NO_OPERATION;
            break;
            case APPSYS_OPT_ACT_MTR_HD_KNF_CL42T:
            ...
            break;
            case APPSYS_OPT_ACT_MTR_HD_KNF_APPSIG:
                Ret_e = RC_WARNING_NO_OPERATION;
            break;
            case APPSYS_OPT_ACT_MTR_HD_KNF_NB:
            default:
        ...
        if(Ret_e == RC_OK)
        {
            g_MtrHdKnf_OptCfg_e = f_actDvcOpt_u8;
        }
    }
...
/******************************************
* APPACT_SPEC_MTR_HD_KNF_PLS_GetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_HD_KNF_PLS_GetValue(t_float32 *f_rawSigValue_pf32)
{
    ...
    else
    {
        switch(g_MtrHdKnf_OptCfg_e)
        {
            ...
            break;
            case APPSYS_OPT_ACT_MTR_HD_KNF_APPSIG:
                Ret_e = APPSIG_GetSignalValue(APPSIG_SIGNAL_ACT_GET_MTR_HD_KNF_PLS, &getVal_f32);
...
/******************************************
* APPACT_SPEC_MTR_HD_KNF_PLS_SetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_HD_KNF_PLS_SetValue(t_float32 f_SigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
    ...
    switch(g_MtrHdKnf_OptCfg_e)
    {
        ...
        case APPSYS_OPT_ACT_MTR_HD_KNF_CL42T:
            Ret_e = APPACT_SPEC_CL42T_PLS_SetValue(   f_SigValue_pf32,
                                                        c_MtrHdKnf_CL42T_Id,
                                                        APPACT_SPEC_MOTOR_HD_KNF_DIR_POS,
...
/******************************************
* APPACT_SPEC_MTR_HD_KNF_SPD_GetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_HD_KNF_SPD_GetValue(t_float32 *f_rawSigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
    t_float32 getVal_f32 = 0.0f;
    ...
    else
    {
        switch(g_MtrHdKnf_OptCfg_e)
        {
            ...
            break;
            case APPSYS_OPT_ACT_MTR_HD_KNF_APPSIG:
                Ret_e = APPSIG_GetSignalValue(APPSIG_SIGNAL_ACT_GET_MTR_HD_KNF_SPD, &getVal_f32);
                *f_rawSigValue_pf32 = (Ret_e == RC_OK) ? getVal_f32 : 0.0f;
            break;
            case APPSYS_OPT_ACT_MTR_HD_KNF_NB:
            default:
...
/******************************************
* APPACT_SPEC_MTR_HD_KNF_SPD_SetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_HD_KNF_SPD_SetValue(t_float32 f_SigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
...
/******************************************
* APPACT_SPEC_MTR_HD_KNF_TRG_GetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_HD_KNF_TRG_GetValue(t_float32 *f_rawSigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
    t_float32 getVal_f32 = 0.0f;
    ...
    else
    {
        switch(g_MtrHdKnf_OptCfg_e)
        {
            ...
            break;
            case APPSYS_OPT_ACT_MTR_HD_KNF_APPSIG:
                Ret_e = APPSIG_GetSignalValue(APPSIG_SIGNAL_ACT_GET_MTR_HD_KNF_TRG, &getVal_f32);
                *f_rawSigValue_pf32 = (Ret_e == RC_OK) ? getVal_f32 : 0.0f;
            break;
            case APPSYS_OPT_ACT_MTR_HD_KNF_NB:
            default:
...
/******************************************
* APPACT_SPEC_MTR_HD_KNF_TRG_SetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_HD_KNF_TRG_SetValue(t_float32 f_SigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
...
static t_eReturnCode s_APPACT_SPEC_CL42T_Cfg(void)
{
    ...
    Ret_e = CL42T_AddMotorConfiguration(   c_MtrHdKnf_CL42T_Id,
                                          motorConfig,
                                          APPACT_SPEC_MOTOR_HD_KNF_ENABLE_DEADTIME,
...
static void s_APPACT_SPEC_CL42T_HealthCallback(t_eCL42T_MotorId f_MotorID_e, t_eCL42T_DiagError f_defaultInfo_e)
{
    if(f_MotorID_e != c_MtrHdKnf_CL42T_Id)
    {
