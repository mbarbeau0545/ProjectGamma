...
#include "./APPACT_SPEC_MTR_WHL_AV_R.h"
...
///@brief Positive direction for wheel AV R (sign applied to pulse count)
///@note  If wheel direction is inverted on the vehicle, change this sign.

///@brief Enable motor Wheel AV R Dead Time
#define APPACT_SPEC_MOTOR_WHL_AV_R_ENABLE_DEADTIME TRUE

#define APPACT_SPEC_MTR_WHL_AV_R_DIR_POS   ((t_sint32)1)
// ********************************************************************
// *                      Types
// ********************************************************************
...
/******************************************
* APPACT_SPEC_MTR_WHL_AV_R_SetCfg
******************************************/
t_eReturnCode APPACT_SPEC_MTR_WHL_AV_R_SetCfg(t_uint8 f_actDvcOpt_u8, t_eAPPACT_ActDriverList *f_drvUsed_pe)
{
    ...
    else
    {
        ...
        {
            case APPSYS_OPT_ACT_MTR_WHL_AV_R_UNUSED:
                Ret_e = RC_WARNING_NO_OPERATION;
            break;

            case APPSYS_OPT_ACT_MTR_WHL_AV_R_CL42T:
            ...
            case APPSYS_OPT_ACT_MTR_WHL_AV_R_APPSIG:
                //---- Get / Set Value from APPSIG ----//
                Ret_e = RC_WARNING_NO_OPERATION;
            break;

            case APPSYS_OPT_ACT_MTR_WHL_AV_R_NB:
            default:
        ...
        if(Ret_e == RC_OK)
        {
            g_MtrWhlAvR_OptCfg_e = (t_eAPPSYS_OptActMtrWhlAvR)f_actDvcOpt_u8;
        }
    }
...
/******************************************
* APPACT_SPEC_MTR_WHL_AV_R_PLS_GetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_WHL_AV_R_PLS_GetValue(t_float32 *f_rawSigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
    ...
    else
    {
        switch(g_MtrWhlAvR_OptCfg_e)
        {
            ...
            case APPSYS_OPT_ACT_MTR_WHL_AV_R_APPSIG:
                Ret_e = APPSIG_GetSignalValue(APPSIG_SIGNAL_ACT_GET_MTR_WHL_AV_R_PLS, &getVal_f32);
...
/******************************************
* APPACT_SPEC_MTR_WHL_AV_R_PLS_SetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_WHL_AV_R_PLS_SetValue(t_float32 f_SigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
    ...
    switch(g_MtrWhlAvR_OptCfg_e)
    {
        ...
        case APPSYS_OPT_ACT_MTR_WHL_AV_R_CL42T:
            Ret_e = APPACT_SPEC_CL42T_PLS_SetValue(   f_SigValue_pf32,
                                                    c_MtrWhlAvR_CL42T_Id,
                                                    APPACT_SPEC_MTR_WHL_AV_R_DIR_POS,
...
/******************************************
* APPACT_SPEC_MTR_WHL_AV_R_SPD_GetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_WHL_AV_R_SPD_GetValue(t_float32 *f_rawSigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
    t_float32 getVal_f32 = 0.0f;
    ...
    else
    {
        switch(g_MtrWhlAvR_OptCfg_e)
        {
            ...
            case APPSYS_OPT_ACT_MTR_WHL_AV_R_APPSIG:
                Ret_e = APPSIG_GetSignalValue(APPSIG_SIGNAL_ACT_GET_MTR_WHL_AV_R_SPD, &getVal_f32);
                *f_rawSigValue_pf32 = (Ret_e == RC_OK) ? getVal_f32 : 0.0f;
            break;
...
/******************************************
* APPACT_SPEC_MTR_WHL_AV_R_SPD_SetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_WHL_AV_R_SPD_SetValue(t_float32 f_SigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
...
/******************************************
* APPACT_SPEC_MTR_WHL_AV_R_TRG_GetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_WHL_AV_R_TRG_GetValue(t_float32 *f_rawSigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
    t_float32 getVal_f32 = 0.0f;
    ...
    else
    {
        switch(g_MtrWhlAvR_OptCfg_e)
        {
            ...
            case APPSYS_OPT_ACT_MTR_WHL_AV_R_APPSIG:
                Ret_e = APPSIG_GetSignalValue(APPSIG_SIGNAL_ACT_GET_MTR_WHL_AV_R_TRG, &getVal_f32);
                *f_rawSigValue_pf32 = (Ret_e == RC_OK) ? getVal_f32 : 0.0f;
            break;
...
/******************************************
* APPACT_SPEC_MTR_WHL_AV_R_TRG_SetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_WHL_AV_R_TRG_SetValue(t_float32 f_SigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
...
static t_eReturnCode s_APPACT_SPEC_CL42T_Cfg(void)
{
    ...
    Ret_e = CL42T_AddMotorConfiguration(   c_MtrWhlAvR_CL42T_Id,
                                            motorConfig,
                                            APPACT_SPEC_MOTOR_WHL_AV_R_ENABLE_DEADTIME,
...
static void s_APPACT_SPEC_CL42T_HealthCallback(t_eCL42T_MotorId f_MotorID_e, t_eCL42T_DiagError f_defaultInfo_e)
{
    if(f_MotorID_e != c_MtrWhlAvR_CL42T_Id)
    {
    ...
    else
    {
        ...
        APPACT_SPEC_CL42T_Diagnostic(   f_defaultInfo_e,
                                        c_MtrWhlAvR_CL42T_Id,
                                        APPSDM_DIAG_ITEM_WHL_AV_R_OPE_ERROR);
    }
