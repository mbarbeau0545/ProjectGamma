...
#include "./APPACT_SPEC_MTR_HD_CNTR_KNF.h"
...
#define APPACT_SPEC_MOTOR_XHD_CNT_KNF_ENABLE_DEADTIME TRUE

///@brief Positive direction for Y
#define APPACT_SPEC_MOTOR_HD_CNT_KNF_DIR_POS ((t_sint32)1)
// ********************************************************************
// *                      Types
// ********************************************************************
...
static t_eAPPSYS_OptActMtrHdCntrKnf g_Mtr_OptCfg_e = APPSYS_OPT_ACT_MTR_HD_CNTR_KNF_NB;
...
t_eReturnCode APPACT_SPEC_MTR_HD_CNTR_KNF_SetCfg(t_uint8 f_actDvcOpt_u8, t_eAPPACT_ActDriverList *f_drvUsed_pe)
{
    ...
    else 
    {
        ...
        {
            case APPSYS_OPT_ACT_MTR_HD_CNTR_KNF_UNUSED:
                Ret_e = RC_WARNING_NO_OPERATION;
            break;
            case APPSYS_OPT_ACT_MTR_HD_CNTR_KNF_CL42T:
            ...
            break;
            case APPSYS_OPT_ACT_MTR_HD_CNTR_KNF_APPSIG:
                //---- Get / Set Value from APPSIG ----//
                Ret_e = RC_WARNING_NO_OPERATION;
            break;
            case APPSYS_OPT_ACT_MTR_HD_CNTR_KNF_NB:
            default:
...
/******************************************
* APPACT_SPEC_MTR_HD_CNTR_KNF_PLS_GetValue
******************************************/
t_eReturnCode APPACT_SPEC_MTR_HD_CNTR_KNF_PLS_GetValue(t_float32 *f_rawSigValue_pf32)
{
    t_eReturnCode Ret_e = RC_OK;
    t_float32 droppPulse_f32;
    //    Your code for MTR_HD_CNTR_KNF_GetIfValue here
    switch(g_Mtr_OptCfg_e)
    {
        ...
        break;
        case APPSYS_OPT_ACT_MTR_HD_CNTR_KNF_APPSIG:
            Ret_e = APPSIG_GetSignalValue(  APPSIG_SIGNAL_ACT_GET_MTR_HD_HOLD_PLS,
                                            &droppPulse_f32);
            if(Ret_e == RC_OK)
            {
                *f_rawSigValue_pf32 = droppPulse_f32;
            }
            else 
            {
                *f_rawSigValue_pf32 = 0.0F;
...
/******************************************
* APPACT_SPEC_MTR_HD_CNTR_KNF_PLS_SetValue
******************************************/
    ...
    switch(g_Mtr_OptCfg_e)
    {
        ...
        case APPSYS_OPT_ACT_MTR_HD_CNTR_KNF_CL42T:
            ...
            Ret_e = APPACT_SPEC_CL42T_PLS_SetValue( f_SigValue_pf32, 
                                                    c_MtrXL_CL42T_Id,
                                                    APPACT_SPEC_MOTOR_HD_CNT_KNF_DIR_POS,
...
t_eReturnCode APPACT_SPEC_MTR_HD_CNTR_KNF_SPD_GetValue(t_float32 *f_rawSigValue_pf32)
{
    ...
    switch(g_Mtr_OptCfg_e)
    {
        ...
        break;
        case APPSYS_OPT_ACT_MTR_HD_CNTR_KNF_APPSIG:
            Ret_e = APPSIG_GetSignalValue(  APPSIG_SIGNAL_ACT_GET_MTR_HD_CNTR_KNF_SPD,
                                            &getSpdValue_f32);
            if(Ret_e == RC_OK)
            {
                *f_rawSigValue_pf32 = getSpdValue_f32;
            }
            else 
            {
                *f_rawSigValue_pf32 = 0.0F;
...
/******************************************
* APPACT_SPEC_MTR_HD_CNTR_KNF_SPD_SetValue
******************************************/
...
/******************************************
* APPACT_SPEC_MTR_HD_CNTR_KNF_TRG_GetValue
******************************************/
...
/******************************************
* APPACT_SPEC_MTR_HD_CNTR_KNF_TRG_SetValue
******************************************/
...
static t_eReturnCode s_APPACT_SPEC_CL42T_Cfg(void)
{
    ...
    Ret_e  = CL42T_AddMotorConfiguration(   c_MtrXL_CL42T_Id,
                                            motorConfig, 
                                            APPACT_SPEC_MOTOR_XHD_CNT_KNF_ENABLE_DEADTIME,
