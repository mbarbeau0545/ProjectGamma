...
#ifndef APPACT_SPEC_PWR_MTR_HD_CNTR_KNF
#define APPACT_SPEC_PWR_MTR_HD_CNTR_KNF
/* CAUTION : Automatic generated code section for ifndef: End */
    ...
    *
    */
    t_eReturnCode APPACT_SPEC_PWR_MTR_HD_CNTR_KNF_SetCfg(t_uint8 f_actDvcOpt_u8, t_eAPPACT_ActDriverList *f_drvUsed_pe);
    ...
    *
    */
    t_eReturnCode APPACT_SPEC_PWR_MTR_HD_CNTR_KNF_RLY_GetValue(t_float32 *f_rawSigValue_pf32);
    ...
    *
    */
    t_eReturnCode APPACT_SPEC_PWR_MTR_HD_CNTR_KNF_RLY_SetValue(t_float32 f_SigValue_pf32);
