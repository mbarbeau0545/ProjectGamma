...
#define APPACT_SPEC_MOTOR_XR_ENABLE_DEADTIME TRUE
...
// *                      Variables
// ********************************************************************
const static t_eCL42T_MotorId c_MtrXR_CL42T_Id = CL42T_MOTOR_2;
...
t_eReturnCode APPACT_SPEC_MTR_XR_SetCfg(t_uint8 f_actDvcOpt_u8, t_eAPPACT_ActDriverList *f_drvUsed_pe)
{
    ...
    {
        //    Your code for MTR_XR_SetActCfg here
...
/******************************************
* APPACT_SPEC_MTR_XR_SPD_GetValue
******************************************/
...
/******************************************
* APPACT_SPEC_MTR_XR_SPD_SetValue
******************************************/
...
/******************************************
* APPACT_SPEC_MTR_XR_TRG_SetValue
******************************************/
...
static t_eReturnCode s_APPACT_SPEC_CL42T_Cfg(void)
{
    ...
    Ret_e  = CL42T_AddMotorConfiguration(   c_MtrXR_CL42T_Id,
                                            motorConfig, 
                                            APPACT_SPEC_MOTOR_XR_ENABLE_DEADTIME,
...
static void s_APPACT_SPEC_CL42T_HealthCallback(t_eCL42T_MotorId f_MotorID_e, t_eCL42T_DiagError f_defaultInfo_e)
{
    if(f_MotorID_e != c_MtrXR_CL42T_Id)
    {
                                                     ...
                                                     t_eCL42T_MotorDirection f_direction_e)
{
    ...
    else 
    {
        ...
        {
            g_droppPulses_s32 += (t_sint32)(f_pulseDropped_u16);
        }
    }
