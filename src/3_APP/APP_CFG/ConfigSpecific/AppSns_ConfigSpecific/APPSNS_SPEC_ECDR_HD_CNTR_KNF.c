...
t_eReturnCode APPSNS_SPEC_ECDR_HD_CNTR_KNF_SetCfg(t_uint8 f_snsDvcOpt_u8, t_eAPPSNS_SnsDriverList *f_drvUsed_pe)
{
    ...
    else 
    {
        ...
        {
            case APPSYS_OPT_SNS_ECDR_HD_CNTR_KNF_UNUSED:
            ...
            case APPSYS_OPT_SNS_ECDR_HD_CNTR_KNF_APPSIG:
                *f_drvUsed_pe = APPSNS_DRV_NB;
                Ret_e = RC_OK;
            break;
            case APPSYS_OPT_SNS_ECDR_HD_CNTR_KNF_NB:
            default:
...
t_eReturnCode APPSNS_SPEC_ECDR_HD_CNTR_KNF_POS_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * f_isValue_OK)
{
    ...
    else 
    {
        switch (g_OptSysCfg_u8)
        {
            ...
            case APPSYS_OPT_SNS_ECDR_HD_CNTR_KNF_APPSIG:
                Ret_e = APPSIG_GetSignalValue(  APPSIG_SIGNAL_SNS_ECDR_HD_CNTR_KNF_POS,
                                                &position_f32);
                if(Ret_e == RC_OK)
                {
...
t_eReturnCode APPSNS_SPEC_ECDR_HD_CNTR_KNF_SPD_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * f_isValue_OK)
{
    ...
    else 
    {
        switch (g_OptSysCfg_u8)
        {
            ...
            case APPSYS_OPT_SNS_ECDR_HD_CNTR_KNF_APPSIG:
                Ret_e = APPSIG_GetSignalValue(  APPSIG_SIGNAL_SNS_ECDR_HD_CNTR_KNF_SPD,
                                                &speed_f32);
                if(Ret_e == RC_OK)
                {
