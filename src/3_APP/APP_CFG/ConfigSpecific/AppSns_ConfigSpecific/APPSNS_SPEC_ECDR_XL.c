...
#define APPSNS_SPEC_ECDR_PULSE_PER_REV ((t_uint16)1000)
/* CAUTION : Automatic generated code section for Include: Start */
...
/******************************************
* APPSNS_SPEC_ECDR_XL_SetCfg
******************************************/
t_eReturnCode APPSNS_SPEC_ECDR_XL_SetCfg(t_uint8 f_snsDvcOpt_u8, t_eAPPSNS_SnsDriverList *f_drvUsed_pe)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for ECDR_XL_SetSnsCfg here
    ...
    else 
    {
        ...
        {
            case APPSYS_OPT_SNS_ECDR_XL_UNUSED:
                *f_drvUsed_pe = APPSNS_DRV_NB;
                Ret_e = RC_WARNING_NO_OPERATION;
                break;

            case APPSYS_OPT_SNS_ECDR_XL_NEMA17:
            {
            ...
            case APPSYS_OPT_SNS_ECDR_XL_APPSIG:
                *f_drvUsed_pe = APPSNS_DRV_NB;
                Ret_e = RC_OK;
            break;
            case APPSYS_OPT_SNS_ECDR_XL_NB:
            default:
...
/******************************************
* APPSNS_SPEC_ECDR_XL_POS_GetSigValue
******************************************/
t_eReturnCode APPSNS_SPEC_ECDR_XL_POS_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * f_isValue_OK)
{
    t_eReturnCode Ret_e = RC_OK;
    ...
    else 
    {
        switch (g_OptSysCfg_u8)
        {
            ...
            case APPSYS_OPT_SNS_ECDR_XL_APPSIG:
                Ret_e = APPSIG_GetSignalValue(  APPSIG_SIGNAL_SNS_ECDR_XL_POS,
                                                &position_f32);
                if(Ret_e == RC_OK)
                {
...
/******************************************
* APPSNS_SPEC_ECDR_XL_POS_FormatValue
******************************************/
t_eReturnCode APPSNS_SPEC_ECDR_XL_POS_FormatValue(t_float32  rawValue_f32, t_float32 *SnsValue_f32)
{
    t_eReturnCode Ret_e = RC_OK;
...
t_eReturnCode APPSNS_SPEC_ECDR_XL_SPD_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * f_isValue_OK)
{
    ...
    else 
    {
        switch (g_OptSysCfg_u8)
        {
            ...
            case APPSYS_OPT_SNS_ECDR_XL_APPSIG:
                Ret_e = APPSIG_GetSignalValue(  APPSIG_SIGNAL_SNS_ECDR_XL_SPD,
                                                &speed_f32);
                if(Ret_e == RC_OK)
                {
