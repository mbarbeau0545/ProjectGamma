...
#include "./APPSNS_SPEC_TRQ_MTR_Z.h"
...
// *                      Defines
// ********************************************************************
#define APPSNS_SPEC_SIG_TRQ (APPSIG_SIGNAL_SNS_TRQ_MTR_Z_TRQ)
/* CAUTION : Automatic generated code section for Include: Start */
...
/******************************************
* APPSNS_SPEC_TRQ_MTR_Z_SetCfg
******************************************/
t_eReturnCode APPSNS_SPEC_TRQ_MTR_Z_SetCfg(t_uint8 f_snsDvcOpt_u8, t_eAPPSNS_SnsDriverList *f_drvUsed_pe)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for TRQ_MTR_Z_SetSnsCfg here
    ...
    else 
    {
        ...
        {
            break;
            case APPSYS_OPT_SNS_TRQ_MTR_Z_APPSIG:
...
/******************************************
* APPSNS_SPEC_TRQ_MTR_Z_TRQ_GetSigValue
******************************************/
t_eReturnCode APPSNS_SPEC_TRQ_MTR_Z_TRQ_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * f_isValue_OK)
{
    t_eReturnCode Ret_e = RC_OK;
    t_float32 sigVal_f32 = 0.0F;
    //    Your code for TRQ_MTR_Z_GetSigValue here
...
/******************************************
* APPSNS_SPEC_TRQ_MTR_Z_TRQ_FormatValue
******************************************/
t_eReturnCode APPSNS_SPEC_TRQ_MTR_Z_TRQ_FormatValue(t_float32  rawValue_f32, t_float32 *SnsValue_f32)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for TRQ_MTR_Z_FormatValSI here
