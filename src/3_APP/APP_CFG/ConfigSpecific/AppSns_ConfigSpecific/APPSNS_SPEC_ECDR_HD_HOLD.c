...
#include "./APPSNS_SPEC_ECDR_HD_HOLD.h"
...
// *                      Defines
// ********************************************************************
#define APPSNS_SPEC_ECDR_ID (FMKIO_INPUT_ENCODER_3)
...
/******************************************
* APPSNS_SPEC_ECDR_HD_HOLD_SetCfg
******************************************/
t_eReturnCode APPSNS_SPEC_ECDR_HD_HOLD_SetCfg(t_uint8 f_snsDvcOpt_u8, t_eAPPSNS_SnsDriverList *f_drvUsed_pe)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for ECDR_HD_HOLD_SetSnsCfg here
    ...
    else 
    {
        ...
        {
            case APPSYS_OPT_SNS_ECDR_HD_HOLD_UNUSED:
            ...
            case APPSYS_OPT_SNS_ECDR_HD_HOLD_APPSIG:
                *f_drvUsed_pe = APPSNS_DRV_NB;
                Ret_e = RC_OK;
            break;
            case APPSYS_OPT_SNS_ECDR_HD_HOLD_NB:
            default:
...
/******************************************
* APPSNS_SPEC_ECDR_HD_HOLD_POS_GetSigValue
******************************************/
t_eReturnCode APPSNS_SPEC_ECDR_HD_HOLD_POS_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * f_isValue_OK)
{
    t_eReturnCode Ret_e = RC_OK;
    t_float32 position_f32;
    //    Your code for ECDR_HD_HOLD_GetSigValue here
    ...
    else 
    {
        switch (g_OptSysCfg_u8)
        {
            ...
            case APPSYS_OPT_SNS_ECDR_HD_HOLD_APPSIG:
                Ret_e = APPSIG_GetSignalValue(  APPSIG_SIGNAL_SNS_ECDR_HD_HOLD_POS,
                                                &position_f32);
                if(Ret_e == RC_OK)
                {
...
/******************************************
* APPSNS_SPEC_ECDR_HD_HOLD_POS_FormatValue
******************************************/
t_eReturnCode APPSNS_SPEC_ECDR_HD_HOLD_POS_FormatValue(t_float32  rawValue_f32, t_float32 *SnsValue_f32)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for ECDR_HD_HOLD_FormatValSI here
...
/******************************************
* APPSNS_SPEC_ECDR_HD_HOLD_SPD_GetSigValue
******************************************/
t_eReturnCode APPSNS_SPEC_ECDR_HD_HOLD_SPD_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * f_isValue_OK)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for ECDR_HD_HOLD_GetSigValue here
    t_float32 speed_f32;
    ...
    else 
    {
        switch (g_OptSysCfg_u8)
        {
            ...
            case APPSYS_OPT_SNS_ECDR_HD_HOLD_APPSIG:
                Ret_e = APPSIG_GetSignalValue(  APPSIG_SIGNAL_SNS_ECDR_HD_HOLD_SPD,
                                                &speed_f32);
                if(Ret_e == RC_OK)
                {
...
/******************************************
* APPSNS_SPEC_ECDR_HD_HOLD_SPD_FormatValue
******************************************/
t_eReturnCode APPSNS_SPEC_ECDR_HD_HOLD_SPD_FormatValue(t_float32  rawValue_f32, t_float32 *SnsValue_f32)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for ECDR_HD_HOLD_FormatValSI here
