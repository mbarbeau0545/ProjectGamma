...
/******************************************
* APPSNS_SPEC_ECDR_Y_SPEED_GetSigValue
******************************************/
t_eReturnCode APPSNS_SPEC_ECDR_Y_SPEED_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * f_isValue_OK)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for ECDR_Y_GetSigValue here
...
/******************************************
* APPSNS_SPEC_ECDR_Y_SPEED_FormatValue
******************************************/
t_eReturnCode APPSNS_SPEC_ECDR_Y_SPEED_FormatValue(t_float32  rawValue_f32, t_float32 *SnsValue_f32)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for ECDR_Y_FormatValSI here
