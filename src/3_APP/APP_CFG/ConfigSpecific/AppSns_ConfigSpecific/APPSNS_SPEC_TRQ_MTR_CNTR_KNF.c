...
// *                      Defines
// ********************************************************************
#define APPSNS_SPEC_SIG_TRQ (APPSIG_SIGNAL_SNS_TRQ_MTR_CNTR_KNF_TRQ)
/* CAUTION : Automatic generated code section for Include: Start */
...
t_eReturnCode APPSNS_SPEC_TRQ_MTR_CNTR_KNF_SetCfg(t_uint8 f_snsDvcOpt_u8, t_eAPPSNS_SnsDriverList *f_drvUsed_pe)
{
    ...
    else 
    {
        ...
        {
            break;
            case APPSYS_OPT_SNS_TRQ_MTR_CNTR_KNF_APPSIG:
                *f_drvUsed_pe = APPSNS_DRV_NB;
                Ret_e = RC_OK;
            break;
            case APPSYS_OPT_SNS_TRQ_MTR_CNTR_KNF_UNUSED:
                Ret_e = RC_WARNING_NO_OPERATION;
                *f_drvUsed_pe = APPSNS_DRV_NB;
            break;
            case APPSYS_OPT_SNS_TRQ_MTR_CNTR_KNF_ACS716:
