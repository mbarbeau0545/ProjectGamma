...
#define APPSDM_CONFIGPUBLIC_H_INCLUDED
    ...
    */
    typedef enum ____t_eAPPSDM_DiagnosticItem
    {
        ...
        APPSDM_DIAG_ITEM_LGC_GTRY_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_LGC_GTRY_X_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_LGC_GTRY_Y_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_LGC_GTRY_Z_OPE_ERROR,// None
