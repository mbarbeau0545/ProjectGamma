...
#define APPSDM_CONFIGPUBLIC_H_INCLUDED
    ...
    */
    typedef enum ____t_eAPPSDM_DiagnosticItem
    {
        ...
        APPSDM_DIAG_ITEM_GTRY_CALIB_ERROR,// None
        APPSDM_DIAG_ITEM_GTRY_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_GTRY_X_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_GTRY_Y_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_GTRY_Z_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_GTRY_X_LIMIT_REACH,// None
        APPSDM_DIAG_ITEM_GTRY_Y_LIMIT_REACH,// None
        APPSDM_DIAG_ITEM_GTRY_Z_LIMIT_REACH,// None
        APPSDM_DIAG_ITEM_HEAD_KNIFE_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_HEAD_CNTR_KNIFE_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_HEAD_TIP_KNIVE_DELTA_LIMIT_ERROR,// None
        APPSDM_DIAG_ITEM_HEAD_TIP_KNIVE_POS_LIMIT_ERROR,// None
        APPSDM_DIAG_ITEM_HEAD_TIP_KNIVE_POS_TIMESTAMPS_ID,// None
        APPSDM_DIAG_ITEM_HEAD_HOLD_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_WHL_AV_L_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_WHL_AV_R_OPE_ERROR,// None
        APPSDM_DIAG_ITEM_WHL_AV_L_DELTA_LIMIT_ERROR,// None
        APPSDM_DIAG_ITEM_WHL_AV_R_DELTA_LIMIT_ERROR,// None
