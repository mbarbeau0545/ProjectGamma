...
#define APPSPM_CONFIGPUBLIC_H_INCLUDED
    ...
    */
    typedef enum
    {
        ...
        APPSPM_PRM_LGC_MTR_XL_RAMP_CTRL_TOTAL_STEP,
        ...
        APPSPM_PRM_LGC_MTR_XR_RAMP_CTRL_TOTAL_STEP,
        ...
        APPSPM_PRM_LGC_MTR_Y_RAMP_CTRL_TOTAL_STEP,
        ...
        APPSPM_PRM_LGC_MTR_Z_RAMP_CTRL_TOTAL_STEP,
