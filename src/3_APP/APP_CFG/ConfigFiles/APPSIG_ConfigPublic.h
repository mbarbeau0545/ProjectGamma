...
#define APPSIG_CONFIGPUBLIC_H_INCLUDED
    ...
    */
    typedef enum
    {
        ...
        APPSIG_SIGNAL_PRM_LGC_MTR_PULSE_ITER_MAX,
        APPSIG_SIGNAL_PRM_LGC_MTR_XL_RAMP_CTRL_KFACTOR,
        APPSIG_SIGNAL_PRM_LGC_MTR_XL_RAMP_CTRL_SLOP_SPEED,
        APPSIG_SIGNAL_PRM_LGC_MTR_XL_RAMP_CTRL_TOTAL_STEP,
        APPSIG_SIGNAL_PRM_LGC_MTR_XL_SPEED_MAX,
        APPSIG_SIGNAL_PRM_LGC_MTR_XL_SPEED_MIN,
        APPSIG_SIGNAL_PRM_LGC_MTR_XR_RAMP_CTRL_KFACTOR,
        APPSIG_SIGNAL_PRM_LGC_MTR_XR_RAMP_CTRL_SLOP_SPEED,
        APPSIG_SIGNAL_PRM_LGC_MTR_XR_RAMP_CTRL_TOTAL_STEP,
        APPSIG_SIGNAL_PRM_LGC_MTR_XR_SPEED_MAX,
        APPSIG_SIGNAL_PRM_LGC_MTR_XR_SPEED_MIN,
        APPSIG_SIGNAL_PRM_LGC_MTR_Y_RAMP_CTRL_KFACTOR,
        APPSIG_SIGNAL_PRM_LGC_MTR_Y_RAMP_CTRL_SLOP_SPEED,
        APPSIG_SIGNAL_PRM_LGC_MTR_Y_RAMP_CTRL_TOTAL_STEP,
        APPSIG_SIGNAL_PRM_LGC_MTR_Y_SPEED_MAX,
        APPSIG_SIGNAL_PRM_LGC_MTR_Y_SPEED_MIN,
        APPSIG_SIGNAL_PRM_LGC_MTR_Z_RAMP_CTRL_KFACTOR,
        APPSIG_SIGNAL_PRM_LGC_MTR_Z_RAMP_CTRL_SLOP_SPEED,
        APPSIG_SIGNAL_PRM_LGC_MTR_Z_RAMP_CTRL_TOTAL_STEP,
        APPSIG_SIGNAL_PRM_LGC_MTR_Z_SPEED_MAX,
        APPSIG_SIGNAL_PRM_LGC_MTR_Z_SPEED_MIN,
    ...
    */
    typedef enum
    {
        ...
        APPSIG_SRL_MSG_MTR_XL_RAMP_CTRL,
        APPSIG_SRL_MSG_MTR_XR_RAMP_CTRL,
        APPSIG_SRL_MSG_MTR_Y_RAMP_CTRL,
        APPSIG_SRL_MSG_MTR_Z_RAMP_CTRL,
        APPSIG_SRL_MSG_MTR_SPEED_CFG1,
        APPSIG_SRL_MSG_MTR_SPEED_CFG_2,
        APPSIG_SRL_MSG_MTR_SPEED_CFG_3,
