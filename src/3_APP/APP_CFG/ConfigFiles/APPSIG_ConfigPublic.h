...
#define APPSIG_CONFIGPUBLIC_H_INCLUDED
    ...
    */
    typedef enum
    {
        ...
        APPSIG_SIGNAL_PRM_LGC_MTR_XL_RAMP_CTRL_SLP_SPD,
        APPSIG_SIGNAL_PRM_LGC_MTR_XL_RAMP_CTRL_NB_STEP,
        ...
        APPSIG_SIGNAL_PRM_LGC_MTR_XR_RAMP_CTRL_SLP_SPD,
        APPSIG_SIGNAL_PRM_LGC_MTR_XR_RAMP_CTRL_NB_STEP,
        ...
        APPSIG_SIGNAL_PRM_LGC_MTR_Y_RAMP_CTRL_SLP_SPD,
        APPSIG_SIGNAL_PRM_LGC_MTR_Y_RAMP_CTRL_NB_STEP,
        APPSIG_SIGNAL_PRM_LGC_MTR_Y_SPEED_MAX,
        APPSIG_SIGNAL_PRM_LGC_MTR_Y_SPEED_MIN,
        APPSIG_SIGNAL_PRM_LGC_MTR_Z_RAMP_CTRL_KFACTOR,
        APPSIG_SIGNAL_PRM_LGC_MTR_Z_RAMP_CTRL_SLP_SPD,
        APPSIG_SIGNAL_PRM_LGC_MTR_Z_RAMP_CTRL_NB_STEP,
