...
#define APPSIG_CONFIGPUBLIC_H_INCLUDED
    ...
    */
    typedef enum
    {
        ...
        APPSIG_SIGNAL_PRM_LGC_GTRY_AXE_X_SAFE_HEIGHT,
        APPSIG_SIGNAL_PRM_LGC_GTRY_AXE_Y_SAFE_HEIGHT,
        APPSIG_SIGNAL_PRM_LGC_GTRY_AXE_Z_SAFE_HEIGHT,
        APPSIG_SIGNAL_SNS_SNSITF_ECDR_XL_POS,
        APPSIG_SIGNAL_SNS_SNSITF_ECDR_XL_SPEED,
        APPSIG_SIGNAL_SNS_SNSITF_ECDR_XR_POS,
        APPSIG_SIGNAL_SNS_SNSITF_ECDR_XR_SPEED,
        APPSIG_SIGNAL_SNS_SNSITF_ECDR_Y_POS,
        APPSIG_SIGNAL_SNS_SNSITF_ECDR_Y_SPEED,
        APPSIG_SIGNAL_SNS_SNSITF_ECDR_Z_POS,
        APPSIG_SIGNAL_SNS_SNSITF_ECDR_Z_SPEED,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_XL_PULSE,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_XL_SPEED,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_XL_TRIGTIME,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_XR_PULSE,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_XR_SPEED,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_XR_TRIGTIME,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_Y_PULSE,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_Y_SPEED,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_Y_TRIGTIME,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_Z_PULSE,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_Z_SPEED,
        APPSIG_SIGNAL_ACT_ACTITF_MTR_Z_TRIGTIME,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_3,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_4,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_5,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_6,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_7,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_8,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_9,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_10,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_1_INFO_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_2_INFO_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_3_INFO_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_4_INFO_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_5_INFO_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_6_INFO_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_7_INFO_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_8_INFO_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_9_INFO_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_10_INFO_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_1_INFO_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_2_INFO_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_3_INFO_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_4_INFO_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_5_INFO_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_6_INFO_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_7_INFO_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_8_INFO_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_9_INFO_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_10_INFO_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_STATE_1,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_STATE_2,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_STATE_3,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_STATE_4,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_STATE_5,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_STATE_6,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_STATE_7,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_STATE_8,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_STATE_9,
        APPSIG_SIGNAL_SDM_DIAG_ITEM_STATE_10,
        APPSIG_SIGNAL_GTRY_FSM_PERIODIC_TASK,
        APPSIG_SIGNAL_GTRY_FSM_PRDTSK_CALIB,
        APPSIG_SIGNAL_GTRY_FSM_PRDTSK_CALIB_OPE_AXE_X,
        APPSIG_SIGNAL_GTRY_FSM_PRDTSK_CALIB_OPE_AXE_Y,
        APPSIG_SIGNAL_GTRY_FSM_PRDTSK_CALIB_OPE_AXE_Z,
        APPSIG_SIGNAL_GTRY_FSM_PRDTSK_OPE,
        APPSIG_SIGNAL_GTRY_FSM_PRDTSK_OPE_CMD_PROCESS,
        APPSIG_SIGNAL_GTRY_AXE_X_POSITION,
        APPSIG_SIGNAL_GTRY_AXE_Y_POSITION,
        APPSIG_SIGNAL_GTRY_AXE_Z_POSITION,
        APPSIG_SIGNAL_GTRY_ALGO_COMPUTE_TIME,
    ...
    */
    typedef enum
    {
        ...
        APPSIG_SRL_MSG_PRM_LGC_GTRY_PARAM_SAFE_HEIGHT,
        APPSIG_SRL_MSG_APPSNS_DEBUG_1,
        APPSIG_SRL_MSG_APPSNS_DEBUG_2,
        APPSIG_SRL_MSG_APPACT_DEBUG_1,
        APPSIG_SRL_MSG_APPACT_DEBUG_2,
        APPSIG_SRL_MSG_APPACT_DEBUG_3,
        APPSIG_SRL_MSG_APPACT_DEBUG_4,
        APPSIG_SRL_MSG_GTRY_DEBUG_POSITION,
        APPSIG_SRL_MSG_GTRY_DEBUG_FSM,
        APPSIG_SRL_MSG_APPSDM_DIAG_ITEM_1,
        APPSIG_SRL_MSG_APPSDM_DIAG_ITEM_2,
        APPSIG_SRL_MSG_APPSDM_DIAG_ITEM_3,
        APPSIG_SRL_MSG_APPSDM_DIAG_ITEM_4,
        APPSIG_SRL_MSG_APPSDM_DIAG_ITEM_5,
        APPSIG_SRL_MSG_APPSDM_DIAG_ITEM_6,
        APPSIG_SRL_MSG_APPSDM_DIAG_ITEM_7,
        APPSIG_SRL_MSG_APPSDM_DIAG_ITEM_8,
        APPSIG_SRL_MSG_APPSDM_DIAG_ITEM_9,
        APPSIG_SRL_MSG_APPSDM_DIAG_ITEM_10,
