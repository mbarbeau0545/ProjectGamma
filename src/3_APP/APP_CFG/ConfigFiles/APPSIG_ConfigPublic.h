...
#define APPSIG_CONFIGPUBLIC_H_INCLUDED
    ...
    */
    typedef enum
    {
        ...
        APPSIG_SRL_MSG_APPACT_DEBUG_CTRL_MTR_XL,
        APPSIG_SRL_MSG_APPACT_DEBUG_CTRL_MTR_XR,
        APPSIG_SRL_MSG_APPACT_DEBUG_CTRL_MTR_Y,
        APPSIG_SRL_MSG_APPACT_DEBUG_CTRL_MTR_Z,
