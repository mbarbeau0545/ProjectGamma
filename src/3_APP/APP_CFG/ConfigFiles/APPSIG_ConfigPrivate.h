...
#define APPSIG_CONFIGPRIVATE_H_INCLUDED
    ...
    #define APPSIG_CAN_ID_PRM_GTRY_CALIB_XL_XR                     ((t_uint32)0x18ff0312)
    #define APPSIG_CAN_ID_PRM_GTRY_CALIB_Y_Z                       ((t_uint32)0x18ff0313)
    #define APPSIG_CAN_ID_PRM_GTRY_CALIB_KNF_CNTR_KNF              ((t_uint32)0x18ff0314)
    #define APPSIG_CAN_ID_PRM_GTRY_CALIB_KNF_HOLD                  ((t_uint32)0x18ff0315)
    #define APPSIG_CAN_ID_PRM_GTRY_CALIB_WHLDIR_AV                 ((t_uint32)0x18ff0316)
    ...
    const t_sAPPSIG_SigCfg c_AppSig_SignalCfg_as[APPSIG_SIGNAL_NB] = {
        ...
        {(t_uint8)32,                                                    APPSIG_SIG_ENCODE_INTEL,                                                 (t_float32)1,                                                     (t_sint32)-1048576                                               },// APPSIG_SIGNAL_LGC_CMD_CALIB_PLS
    ...
    const t_sAPPSIG_MsgSignalsCfg c_AppSig_Can_PRM_GTRY_CALIB_XL_XR_as[4] = {
    ...
    const t_sAPPSIG_MsgSignalsCfg c_AppSig_Can_PRM_GTRY_CALIB_Y_Z_as[4] = {
    ...
    const t_sAPPSIG_MsgSignalsCfg c_AppSig_Can_PRM_GTRY_CALIB_KNF_CNTR_KNF_as[4] = {
    ...
    const t_sAPPSIG_MsgSignalsCfg c_AppSig_Can_PRM_GTRY_CALIB_KNF_HOLD_as[2] = {
    ...
    const t_sAPPSIG_MsgSignalsCfg c_AppSig_Can_PRM_GTRY_CALIB_WHLDIR_AV_as[4] = {
    ...
    {APPSIG_CAN_ID_PRM_GTRY_PARAM_SAFE_HEIGHT,               APPSIG_TX_POLICY_NB,                                   {APPSIG_MSG_DIR_RX,             APPSIG_MSG_DIR_UNUSED,         APPSIG_MSG_DIR_UNUSED},          (t_uint16)0,                                            (t_uint16)65535,                                        c_AppSig_Can_PRM_GTRY_PARAM_SAFE_HEIGHT_as,             (t_uint8)3}, // APPSIG_CAN_PRM_GTRY_PARAM_SAFE_HEIGHT
    {APPSIG_CAN_ID_PRM_GTRY_CALIB_XL_XR,                     APPSIG_TX_POLICY_NB,                                   {APPSIG_MSG_DIR_RX,             APPSIG_MSG_DIR_UNUSED,         APPSIG_MSG_DIR_UNUSED},          (t_uint16)0,                                            (t_uint16)65535,                                        c_AppSig_Can_PRM_GTRY_CALIB_XL_XR_as,                   (t_uint8)4}, // APPSIG_CAN_PRM_GTRY_CALIB_XL_XR
    {APPSIG_CAN_ID_PRM_GTRY_CALIB_Y_Z,                       APPSIG_TX_POLICY_NB,                                   {APPSIG_MSG_DIR_RX,             APPSIG_MSG_DIR_UNUSED,         APPSIG_MSG_DIR_UNUSED},          (t_uint16)0,                                            (t_uint16)65535,                                        c_AppSig_Can_PRM_GTRY_CALIB_Y_Z_as,                     (t_uint8)4}, // APPSIG_CAN_PRM_GTRY_CALIB_Y_Z
    {APPSIG_CAN_ID_PRM_GTRY_CALIB_KNF_CNTR_KNF,              APPSIG_TX_POLICY_NB,                                   {APPSIG_MSG_DIR_UNUSED,         APPSIG_MSG_DIR_RX,             APPSIG_MSG_DIR_UNUSED},          (t_uint16)0,                                            (t_uint16)65535,                                        c_AppSig_Can_PRM_GTRY_CALIB_KNF_CNTR_KNF_as,            (t_uint8)4}, // APPSIG_CAN_PRM_GTRY_CALIB_KNF_CNTR_KNF
    {APPSIG_CAN_ID_PRM_GTRY_CALIB_KNF_HOLD,                  APPSIG_TX_POLICY_NB,                                   {APPSIG_MSG_DIR_UNUSED,         APPSIG_MSG_DIR_RX,             APPSIG_MSG_DIR_UNUSED},          (t_uint16)0,                                            (t_uint16)65535,                                        c_AppSig_Can_PRM_GTRY_CALIB_KNF_HOLD_as,                (t_uint8)2}, // APPSIG_CAN_PRM_GTRY_CALIB_KNF_HOLD
    {APPSIG_CAN_ID_PRM_GTRY_CALIB_WHLDIR_AV,                 APPSIG_TX_POLICY_NB,                                   {APPSIG_MSG_DIR_UNUSED,         APPSIG_MSG_DIR_UNUSED,         APPSIG_MSG_DIR_RX},          (t_uint16)0,                                            (t_uint16)65535,                                        c_AppSig_Can_PRM_GTRY_CALIB_WHLDIR_AV_as,               (t_uint8)4}, // APPSIG_CAN_PRM_GTRY_CALIB_WHLDIR_AV
