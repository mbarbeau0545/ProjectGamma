...
#define APPACT_CONFIGPRIVATE_H_INCLUDED
    ...
    #include "APP_CFG\\ConfigSpecific\\AppAct_ConfigSpecific/APPACT_SPEC_MTR_WHL_AV_R.h"
    #include "APP_CFG\\ConfigSpecific\\AppAct_ConfigSpecific/APPACT_SPEC_MTR_WHL_AV_R.h"
    #include "APP_CFG\\ConfigSpecific\\AppAct_ConfigSpecific/APPACT_SPEC_MTR_HD_KNIFE.h"
    #include "APP_CFG\\ConfigSpecific\\AppAct_ConfigSpecific/APPACT_SPEC_MTR_HD_KNIFE.h"
    #include "APP_CFG\\ConfigSpecific\\AppAct_ConfigSpecific/APPACT_SPEC_MTR_HD_KNIFE.h"
    #include "APP_CFG\\ConfigSpecific\\AppAct_ConfigSpecific/APPACT_SPEC_MTR_HD_CNTR_KNIFE.h"
    #include "APP_CFG\\ConfigSpecific\\AppAct_ConfigSpecific/APPACT_SPEC_MTR_HD_CNTR_KNIFE.h"
    #include "APP_CFG\\ConfigSpecific\\AppAct_ConfigSpecific/APPACT_SPEC_MTR_HD_CNTR_KNIFE.h"
    ...
    */
    ...
    const t_sAPPACT_SysActCfg c_AppAct_SysAct_as[APPACT_ACTITF_NB] = {
        ...
        {APPACT_ACTDVC_MTR_HD_KNIFE,                                  APPACT_SPEC_MTR_HD_KNIFE_PLS_SetValue,                      APPACT_SPEC_MTR_HD_KNIFE_PLS_GetValue,                      APPSIG_SIGNAL_ACT_SET_MTR_HD_KNIFE_PLS,                      APPSIG_SIGNAL_ACT_GET_MTR_HD_KNIFE_PLS,                      APPSIG_SIGNAL_ACT_CTRL_MTR_HD_KNIFE_PLS},//APPACT_ACTITF_MTR_HD_KNIFE_PLS
        {APPACT_ACTDVC_MTR_HD_KNIFE,                                  APPACT_SPEC_MTR_HD_KNIFE_SPD_SetValue,                      APPACT_SPEC_MTR_HD_KNIFE_SPD_GetValue,                      APPSIG_SIGNAL_ACT_SET_MTR_HD_KNIFE_SPD,                      APPSIG_SIGNAL_ACT_GET_MTR_HD_KNIFE_SPD,                      APPSIG_SIGNAL_ACT_CTRL_MTR_HD_KNIFE_SPD},//APPACT_ACTITF_MTR_HD_KNIFE_SPD
        {APPACT_ACTDVC_MTR_HD_KNIFE,                                  APPACT_SPEC_MTR_HD_KNIFE_TRG_SetValue,                      APPACT_SPEC_MTR_HD_KNIFE_TRG_GetValue,                      APPSIG_SIGNAL_ACT_SET_MTR_HD_KNIFE_TRG,                      APPSIG_SIGNAL_ACT_GET_MTR_HD_KNIFE_TRG,                      APPSIG_SIGNAL_ACT_CTRL_MTR_HD_KNIFE_TRG},//APPACT_ACTITF_MTR_HD_KNIFE_TRG
        {APPACT_ACTDVC_MTR_HD_CNTR_KNIFE,                             APPACT_SPEC_MTR_HD_CNTR_KNIFE_PLS_SetValue,                 APPACT_SPEC_MTR_HD_CNTR_KNIFE_PLS_GetValue,                 APPSIG_SIGNAL_ACT_SET_MTR_HD_CNTR_KNIFE_PLS,                 APPSIG_SIGNAL_ACT_GET_MTR_HD_CNTR_KNIFE_PLS,                 APPSIG_SIGNAL_ACT_CTRL_MTR_HD_CNTR_KNIFE_PLS},//APPACT_ACTITF_MTR_HD_CNTR_KNIFE_PLS
        {APPACT_ACTDVC_MTR_HD_CNTR_KNIFE,                             APPACT_SPEC_MTR_HD_CNTR_KNIFE_SPD_SetValue,                 APPACT_SPEC_MTR_HD_CNTR_KNIFE_SPD_GetValue,                 APPSIG_SIGNAL_ACT_SET_MTR_HD_CNTR_KNIFE_SPD,                 APPSIG_SIGNAL_ACT_GET_MTR_HD_CNTR_KNIFE_SPD,                 APPSIG_SIGNAL_ACT_CTRL_MTR_HD_CNTR_KNIFE_SPD},//APPACT_ACTITF_MTR_HD_CNTR_KNIFE_SPD
        {APPACT_ACTDVC_MTR_HD_CNTR_KNIFE,                             APPACT_SPEC_MTR_HD_CNTR_KNIFE_TRG_SetValue,                 APPACT_SPEC_MTR_HD_CNTR_KNIFE_TRG_GetValue,                 APPSIG_SIGNAL_ACT_SET_MTR_HD_CNTR_KNIFE_TRG,                 APPSIG_SIGNAL_ACT_GET_MTR_HD_CNTR_KNIFE_TRG,                 APPSIG_SIGNAL_ACT_CTRL_MTR_HD_CNTR_KNIFE_TRG},//APPACT_ACTITF_MTR_HD_CNTR_KNIFE_TRG
    ...
    const t_sAPPACT_ActDvcOpeCfg c_AppAct_ActDvcOpeCfg_as[APPACT_ACTDVC_NB] = {
        ...
        {APPSYS_OPT_ID_ACT_MTR_HD_KNIFE,                              APPACT_SPEC_MTR_HD_KNIFE_SetCfg},                              // APPACT_ACTDVC_MTR_HD_KNIFE
        {APPSYS_OPT_ID_ACT_MTR_HD_CNTR_KNIFE,                         APPACT_SPEC_MTR_HD_CNTR_KNIFE_SetCfg},                         // APPACT_ACTDVC_MTR_HD_CNTR_KNIFE
