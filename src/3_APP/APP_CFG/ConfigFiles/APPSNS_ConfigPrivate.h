...
#define APPSNS_CONFIGPRIVATE_H_INCLUDED
   ...
   typedef t_eReturnCode (t_cbAppSns_ConversionMngmt)(t_float32 f_rawValue_f32, t_float32 *f_snsValue_ps16);
    ...
    const t_sAPPSNS_SysSnsCfg c_AppSns_SysSns_as[APPSNS_SNSITF_NB] = {
        ...
        {APPSNS_SNSDVC_ECDR_HD_KNF,                                   APPSNS_MEASTYPE_DISTANCE,                                    APPSNS_SPEC_ECDR_HD_KNF_POS_GetSigValue,                       APPSNS_SPEC_ECDR_HD_KNF_POS_FormatValue,                    APPSIG_SIGNAL_SNS_ECDR_HD_KNF_POS},//APPSNS_SNSITF_ECDR_HD_KNF_POS
        ...
        {APPSNS_SNSDVC_ECDR_HD_CNTR_KNF,                              APPSNS_MEASTYPE_DISTANCE,                                    APPSNS_SPEC_ECDR_HD_CNTR_KNF_POS_GetSigValue,                  APPSNS_SPEC_ECDR_HD_CNTR_KNF_POS_FormatValue,               APPSIG_SIGNAL_SNS_ECDR_HD_CNTR_KNF_POS},//APPSNS_SNSITF_ECDR_HD_CNTR_KNF_POS
