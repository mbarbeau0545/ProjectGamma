...
#define FMKIO_CONFIGPRIVATE_H_INCLUDED
    ...
    const t_sFMKIO_BspTimerSigCfg c_OutPwmSigBspMap_as[FMKIO_OUTPUT_SIGPWM_NB] = {
        ...
        {{FMKIO_GPIO_PORT_B,             FMKIO_GPIO_PIN_14},             GPIO_AF13_HRTIM1,              (t_uint8)FMKHRT_HR_LINE_7,                                   FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_5,
        {{FMKIO_GPIO_PORT_C,             FMKIO_GPIO_PIN_8},              GPIO_AF3_HRTIM1,               (t_uint8)FMKHRT_HR_LINE_9,                                   FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_6,
        {{FMKIO_GPIO_PORT_C,             FMKIO_GPIO_PIN_9},              GPIO_AF3_HRTIM1,               (t_uint8)FMKHRT_HR_LINE_10,                                  FMKIO_ITLINE_TYPE_HRTIM},    // FMKIO_OUTPUT_SIGPWM_7,
    };
