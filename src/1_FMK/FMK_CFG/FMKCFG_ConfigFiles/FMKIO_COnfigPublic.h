...
#define FMKIO_ConfigPublic_H_INCLUDED
    ...
    */
    typedef enum
    {
        FMKIO_INPUT_SIGANA_1 = 0,                  /**< Reference to PA4 */
        FMKIO_INPUT_SIGANA_2,                        /**< Reference to PB1 */
    ...
    */
    typedef enum
    {
        FMKIO_INPUT_SIGFREQ_1 = 0,                  /**< Reference to PA0, TIMER_5 CHANNEL_1 */
        FMKIO_INPUT_SIGFREQ_2,                        /**< Reference to PA1, TIMER_5 CHANNEL_2 */
        FMKIO_INPUT_SIGFREQ_3,                        /**< Reference to PA2, TIMER_5 CHANNEL_3 */
        FMKIO_INPUT_SIGFREQ_4,                        /**< Reference to PA3, TIMER_5 CHANNEL_4 */
    ...
    */
    typedef enum
    {
        FMKIO_INPUT_SIGEVNT_1 = 0,                  /**< Reference to PC3 */
        FMKIO_INPUT_SIGEVNT_2,                        /**< Reference to PC2 */
        FMKIO_INPUT_SIGEVNT_3,                        /**< Reference to PB0 */
    ...
    */
    typedef enum
    {
        ...
        FMKIO_OUTPUT_SIGDIG_8,                        /**< Reference to PC14 */
    ...
    */
    typedef enum
    {
        ...
        FMKIO_COM_SIGNAL_SERIAL_2,                        /**< Rx -> PG3, Tx -> PG2, Reference to Serial PIN_3 */
