...
#define FMKIO_ConfigPublic_H_INCLUDED
    ...
    */
    typedef enum
    {
        ...
        FMKIO_INPUT_SIGDIG_2,                        /**< Reference to PC14 */
    ...
    */
    typedef enum
    {
        ...
        FMKIO_INPUT_SIGEVNT_5,                        /**< Reference to PC10 */
        FMKIO_INPUT_SIGEVNT_6,                        /**< Reference to PA7 */
        FMKIO_INPUT_SIGEVNT_7,                        /**< Reference to PA5 */
        FMKIO_INPUT_SIGEVNT_8,                        /**< Reference to PC15 */
    ...
    */
    typedef enum
    {
        ...
        FMKIO_OUTPUT_SIGPWM_2,                        /**< Reference to PC12, TIMER_5 CHANNEL_2 ,Pwm with Adaptable Frequency and DutyCycle */
        FMKIO_OUTPUT_SIGPWM_3,                        /**< Reference to PB15, TIMER_15 CHANNEL_2 ,Pwm with Adaptable Frequency and DutyCycle */
        FMKIO_OUTPUT_SIGPWM_4,                        /**< Reference to PC7, TIMER_8 CHANNEL_2 ,Pwm with Adaptable Frequency, DutyCycle and Pulses, (WaveForm pulses cannot be change during generation) */
        FMKIO_OUTPUT_SIGPWM_5,                        /**< Reference to PB2, TIMER_20 CHANNEL_1 ,Pwm with Adaptable Frequency, DutyCycle and Pulses, (WaveForm pulses cannot be change during generation) */
        FMKIO_OUTPUT_SIGPWM_6,                        /**< Reference to PA9, TIMER_1 CHANNEL_2 ,Pwm with Adaptable Frequency, DutyCycle and Pulses, (WaveForm pulses cannot be change during generation)
        ...
        FMKIO_OUTPUT_SIGPWM_14,                       /**< Reference to PC9, TIMER_E CHANNEL_2 ,Pwm with Adaptable Frequency > x Hz @ref FMKHRT_ConfigurePwmLine, DutyCycle, Pulses and current Feedback, (Waveform Pulses can be change during generation)
